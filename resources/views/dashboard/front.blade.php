                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input value="{{$front->title_1}}" type="text" name="title_1" id="title_1"
                                                    ...
                                                    <div class="md:flex">
                                                        <div class="md:flex-shrink-0">
                                                            <video class="h-full w-full object-cover
                                                                 md:w-48" src="{{url('/')}}/{{$front->video_1}}">
                                                        </div>
                                                        <div class="p-3">
                                                            <div class="uppercase tracking-wide text-sm
                                                                text-indigo-500 font-semibold">Change Image</div>
                                                            <input  type="file" rows="6" name="video_1"
                                                                    class=" focus:ring-indigo-500
                                                           focus:border-indigo-500 w-full
                                                           sm:text-sm border-gray-300
                                                           rounded-md">
                                            ...
                                            <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                                ...
                                                <input value="{{$front->button_1}}" type="text" name="button_1" id="small_title"
